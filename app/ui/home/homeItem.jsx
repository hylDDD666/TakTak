  ...
  return (
    <div className="border-b border-slate-200 border-solid pt-6">
      <Row justify={'center'} wrap={false}>
        <Col flex={'60px'}>
          <Avatar size={56} src="https://api.dicebear.com/7.x/miniavs/svg?seed=1" />
        </Col>
        <Col flex={'auto'} style={{ maxWidth: '510px' }}>
          ...
          <div className="flex">
            ...
            >
              ...
              <span className={`pr-5 ${isCollipse ? 'overflow-hidden line-clamp-2' : ''}`}>
                Respuesta a @anacristinamunaresmejia Nuevas imágenes de la tribuMante #mante
                #tribumante #tribe #tribu #misterio #mantetribe#losttribe
              </span>
            </div>
          </div>
        </Col>
